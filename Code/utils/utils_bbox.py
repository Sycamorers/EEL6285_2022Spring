...
# Resize the output relative to the original image
...
# Center decoding, width and height decoding
...
def non_max_suppression(detection, conf_thres=0.5, nms_thres=0.3):
    # Find the boxes in this image that have a score greater than the threshold function.
    # Before performing the filtering of overlapping boxes
    # Performing filtering of scores can significantly reduce the number of boxes.
